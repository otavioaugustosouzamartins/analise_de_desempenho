...
int main(){
    ...
    double intervalo_pra_coleta = 100.0;  // Intervalo para coleta de dados a cada 100 segundos
    double proxima_coleta = intervalo_pra_coleta;
    ...
    while(tempo_decorrido <= tempo_simulacao){
        ...
        if (tempo_decorrido >= proxima_coleta) {
            ew_chegadas.soma_areas += (tempo_decorrido - ew_chegadas.tempo_anterior) * ew_chegadas.num_eventos;
            ew_saidas.soma_areas += (tempo_decorrido - ew_saidas.tempo_anterior) * ew_saidas.num_eventos;
            ...
            proxima_coleta += intervalo_pra_coleta;
        }
    }
